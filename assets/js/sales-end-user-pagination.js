...
function openViewPopup(btn) {
  ...
  // Fill popup spans (read-only)
  document.querySelector("#popupOverlay .view-first-name").textContent = firstName;
  document.querySelector("#popupOverlay .view-middle-initial").textContent = middleInitial;
  document.querySelector("#popupOverlay .view-surname").textContent = surname;
  document.querySelector("#popupOverlay .view-email").textContent = email;
  document.querySelector("#popupOverlay .view-phone").textContent =
  ...
  function renderTable() {
    ...
    paginatedUsers.forEach((user) => {
      ...
      tr.innerHTML = `
        ...
        <td>
          <button class="view-btn-main" onclick="openViewPopup(this)"><i class="fas fa-eye"></i> View</button>
        </td>
      `;
